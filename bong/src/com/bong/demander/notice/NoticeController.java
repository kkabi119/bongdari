...
public class NoticeController {
	...
	public ModelAndView demanderNoticeList(
		...
		ModelAndView mav = new ModelAndView(".four.demander.dari.notice.list.공지게시판");
	...
	public ModelAndView readdemanderNotice(HttpSession session,
		...
		ModelAndView mav = new ModelAndView(".four.demander.dari.notice.article.공지글보기");
	...
	public ModelAndView updatedemanderNotice(
		...
		ModelAndView mav=new ModelAndView(".four.demander.dari.notice.created.공지글수정");
		mav.addObject("dto", dto);
		mav.addObject("demander_seq",demander_seq);
	...
	public ModelAndView insertNoticeForm(
		...
		ModelAndView mav = new ModelAndView(".four.demander.dari.notice.created.공지글쓰기");
