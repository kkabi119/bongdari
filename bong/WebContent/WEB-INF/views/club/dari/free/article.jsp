...
<c:if test="${sessionScope.member.userId=='admin' || sessionScope.member.userId==dto.userId}">
  ...
  var url = "<%=cp%>/club/${clubSeq}/free/delete?" + params;
...
<c:if test="${sessionScope.member.userId==dto.userId}">
  ...
  var page = "${page}";
  var params = "num="+num+"&page="+page;
  var url = "<%=cp%>/club/${clubSeq}/free/update?" + params;
                            ...
                            <div class="single-blog blog-details two-column">
                               ...
                               <c:if test="${not empty preReadDto}">
                                    <div class="post-bottom overflow" style="margin-top: 0px">
                                  			...
                                  			<a href="<%=cp%>/club/${clubSeq}/free/article?${params}&num=${preReadDto.clubFreeIdx}">이전글 : ${preReadDto.subject}</a>
                                ...
                                <c:if test="${not empty nextReadDto}">    
                                    <div class="post-bottom overflow" style="margin-top: 0px">
                                  			...
                                  			<a href="<%=cp%>/club/${clubSeq}/free/article?${params}&num=${nextReadDto.clubFreeIdx}">다음글 : ${nextReadDto.subject}</a>
                               ...
                               <div>
                                    ...
                                    <div style="float:right; padding-top: 10px;padding-bottom: 10px;">
                      					<button type="button" class="btn btn-info" style="padding:10px 15px ; color:white; border:none;" onclick="updateFree();"> 수정 <span class="fa fa-pencil"></span></button>
                  					</div>
                  					<div style="float:right; padding-top: 10px;padding-bottom: 10px; padding-right: 5px">
                      					<button type="button" class="btn btn-default" style="padding:10px 15px ;" onclick="deleteFree();"> 삭제 <span class="fa fa-times"></span></button>
                  					</div>
                  				</div>
