...
<c:if test="${sessionScope.member.userId=='admin' || sessionScope.member.userId==dto.userId}">
  ...
  var url = "<%=cp%>/club/index/notice/delete?" + params;
...
<c:if test="${sessionScope.member.userId==dto.userId}">
  ...
  var page = "${page}";
  var params = "num="+num+"&page="+page;
  var url = "<%=cp%>/club/index/notice/update?" + params;
                            ...
                            <div class="single-blog blog-details two-column">
                               ...
                               <c:if test="${not empty preReadDto }">
                                    <div class="post-bottom overflow" style="margin-top: 0px">
                                  			...
                                  			<a href="<%=cp%>/club/index/notice/article?${params}&num=${preReadDto.clubNoticeIdx}">이전글 : ${preReadDto.subject}</a>
                                ...
                                <c:if test="${not empty nextReadDto }">    
                                    <div class="post-bottom overflow" style="margin-top: 0px">
                                  			...
                                  			<a href="<%=cp%>/club/index/notice/article?${params}&num=${nextReadDto.clubNoticeIdx}">다음글 : ${nextReadDto.subject}</a>
