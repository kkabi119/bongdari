...
<script type="text/javascript">
  ...
  <div class="table-responsive" style="clear: both;">
           <div>
               <table class="table">
                    <thead >
                    <h1 style="color:#5bc0de"><i class="fa fa-bell"></i>내 정보</h1>
                   </thead>
                    <tbody>
                         <tr>
                        	<td  bgcolor="#DFE6E8" style="color:black;;border-top:none; text-align: left; width:100px; height:45px; ">
                            		<span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span>&nbsp;아이디
                            </td>
                            <td colspan="3" style="text-align: left; width:200px; height:45px; ">
                            	${dto.userId}
                            </td>
                        </tr>
                         <tr>
                        ...
                        <tr>
                        	<td  bgcolor="#DFE6E8" style="color:black;;border-top:none; text-align: left; width:100px; height:45px; ">
                            		<span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span>&nbsp;내 사진
                            </td>
                            <td colspan="3" style="text-align: left; width:200px; height:45px; ">
                            	<div class="form-group">
        <label class="col-sm-2 control-label" for="memImgname"></label>
        <div class="col-sm-7">
