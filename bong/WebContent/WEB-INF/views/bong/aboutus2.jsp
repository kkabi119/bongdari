...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 text-center">
                    <img src="<%=cp%>/res/images/aboutus/5.png" class="margin-bottom" alt="">
            ...
            <div class="row">
                <div class="about-us">
                    <div class="col-sm-7 wow fadeInLeft" data-wow-duration="1000ms" data-wow-delay="300ms">
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                <img src="<%=cp%>/res/images/aboutus/6.png" class="img-responsive" alt="">
                            </div>
                            <div class="col-sm-7">
    ...
    <script type="text/javascript" src="<%=cp%>/res/js/jquery.countTo.js"></script>
