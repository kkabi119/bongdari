   						...
   						<li class="media">
                                            ...
                                            <div style="clear: both; margin-top:10px; padding: 5px; border-top: #d5d5d5 solid 1px;">
           									 ...
           									 <div style="text-align: right; padding-top: 10px;">
                      								<button type="button" class="btn btn-info" style="padding:10px 15px ; color:white; border:none;" onclick="sendReplyAnswer('${Rdto.serviceReviewIdx}','${Rdto.replyNum}')"> 답글등록 <span class="fa fa-pencil"></span></button>
                 							 </div>
                 							 <div id="listReplyAnswer${Rdto.replyNum}" style="padding-top: 5px;"></div>                                       
                                          </div>
                                        </li>
