...
<script type="text/javascript">
 function check() {
        ...
        var mode="${mode}";
    	if(mode=="created")
    		f.action="<%=cp%>/demander/${demander_seq}/notice/created";
    	else if(mode=="update")
    		f.action="<%=cp%>/demander/${demander_seq}/notice/update";
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="4" style="text-align: center; padding-top: 15px;">
                                  ...
                                  <button type="button" class="btn btn-default" style="color:#5bc0de;" onclick="javascript:location.href='<%=cp%>/demander/${demander_seq}/notice/list';"> 취소 </button>
