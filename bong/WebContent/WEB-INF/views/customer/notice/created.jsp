...
<div class="bodyFrame2" >
    <div class="body-title">
          <h2 style="color:#F0AD4E;"><span class="glyphicon glyphicon-book" style="color: #F0AD4E;"></span> 공지글쓰기 </h2>
    </div>
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="4" style="text-align: center; padding-top: 15px;">
                                  ...
                                  <button type="button" class="btn btn-default" style="color:#F0AD4E;" onclick="javascript:location.href='<%=cp%>/notice/list';"> 취소 </button>
